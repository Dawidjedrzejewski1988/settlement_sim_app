...
class PolicyPanel extends StatefulWidget {
  ...
  @override
  State<PolicyPanel> createState() => _PolicyPanelState();
}
...
class _PolicyPanelState extends State<PolicyPanel> {
                    ...
                    child: Column(
                      children: [
                        ...
                        categoryButton(
                          ...
                          title: "Polityka żywnościowa",
                        ),
                        const SizedBox(height: 14),
                        categoryButton(
                          type: "work",
                          icon: Icons.work,
                          title: "Polityka pracy",
                        ),
                      ],
                    ),
                  ),
                        ...
                        children: [
                          ...
                          Expanded(
                            child: ListView.builder(
                              itemCount: currentPolicy.options.length,
                              itemBuilder: (_, i) {
                                final option = currentPolicy.options[i];

                                final selected = option.id == currentActive;
      ...
      child: InkWell(
        ...
        child: AnimatedContainer(
          ...
          decoration: BoxDecoration(
            ...
            borderRadius: BorderRadius.circular(18),
            border: Border.all(
              color: selected ? UiColors.gold : Colors.white10,
              width: selected ? 2 : 1,
            ),
          ),
          child: Row(
  ...
  Widget buildEffect(
    ...
    switch (effect.type) {
      case "tax_rate":
        final percent = ((effect.value - 1) * 100).round();

        icon = Icons.attach_money;

        text = "${percent > 0 ? "+" : ""}$percent% podatki";
      ...
      case "morale":
        ...
        text = "${effect.value > 0 ? "+" : ""}${effect.value.toInt()} morale";
      ...
      case "food_consumption":
        ...
        text = "${percent > 0 ? "+" : ""}$percent% żywność";
      ...
      case "production_speed":
        ...
        text = "${percent > 0 ? "+" : ""}$percent% produkcja";
      ...
      case "population_growth":
        ...
        text = "${percent > 0 ? "+" : ""}$percent% populacja";
