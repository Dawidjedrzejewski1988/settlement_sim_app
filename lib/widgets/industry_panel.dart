                              ...
                              return GestureDetector(
                                ...
                                child: AnimatedContainer(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    border: Border.all(
                                      color: selected ? UiColors.gold : UiColors.gold.withValues(alpha: 0.14),
                                    ),
                                    ...
                                    children: [
                                      Container(
                                        ...
                                        decoration: BoxDecoration(
                                          ...
                                          border: Border.all(
                                            color: UiColors.gold.withValues(alpha: 0.45),
                                          ),
                                        ),
                                          ...
                                          children: [
                                            ...
                                            ClipRRect(
                                              ...
                                              child: LinearProgressIndicator(
                                                minHeight: 8,
                                                value: industry.progressPercent / 100,
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  border: Border.all(
                                    color: UiColors.gold.withValues(alpha: 0.35),
                                  ),
                                ),
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Wrap(
                                  ...
                                  children: selectedIndustry.rewards.where((r) => r.unlocked).map((reward) {
                                    return Container(
                                      width: 300,
                                ...
                                Expanded(
                                  child: Center(
                                    child: Row(
                                      ...
                                      children: selectedIndustry.rewards.map((reward) {
                                        final unlocked = reward.unlocked;
                                        final current = selectedIndustry.level == reward.level;
                                          ...
                                          children: [
                                            Tooltip(
                                              ...
                                              decoration: BoxDecoration(
                                                ...
                                                border: Border.all(
                                                  color: UiColors.gold.withValues(alpha: 0.25),
                                                ),
                                              ),
                                                  ...
                                                  AnimatedContainer(
                                                    ...
                                                    decoration: BoxDecoration(
                                                      ...
                                                      color: unlocked
                                                          ...
                                                          : current
                                                              ? UiColors.gold.withValues(alpha: 0.18)
                                                              : Colors.black45,
                                            ...
                                            if (reward != selectedIndustry.rewards.last)
                                              Container(
                                                width: 90,
                                                height: 2,
