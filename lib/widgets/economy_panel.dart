...
class _EconomyPanelState extends State<EconomyPanel> {
  ...
  Map<String, String> data(String code) {
    switch (code) {
      ...
      case "Stone":
        return {
          "name": "Kamień",
          "icon": "assets/icons/resources/stone_icon.png"
        };
      ...
      case "Plank":
        return {
          "name": "Deski",
          "icon": "assets/icons/resources/plank_icon.png"
        };

      case "Berries":
        return {
          "name": "Jagody",
          "icon": "assets/icons/resources/berries_icon.png"
        };

      case "StoneTools":
        return {
          "name": "Narzędzia",
          "icon": "assets/icons/resources/stonetools_icon.png"
        };

      case "Wheat":
        return {
          "name": "Pszenica",
          "icon": "assets/icons/resources/wheat_icon.png"
        };

      case "Flour":
        return {
          "name": "Mąka",
          "icon": "assets/icons/resources/flour_icon.png"
        };
  ...
  Widget build(BuildContext context) {
    final upkeep =
        widget.moneyPerSec < 0 ? widget.moneyPerSec.abs() * 3600 : 0.0;
                      ...
                      itemBuilder: (_, i) {
                        if (i == 0) {
                          return card(
                            ...
                            rate:
                                (widget.moneyPerSec * 3600).toStringAsFixed(1),
                            positive: widget.moneyPerSec >= 0,
                            subtitle:
                                "Utrzymanie: -${upkeep.toStringAsFixed(1)}/h",
                          );
                        }
                      ...
                      child: Column(
                        children: [
                          consumption(
                            ...
                            value:
                                "-${widget.settlement.foodConsumptionPerHour.toStringAsFixed(1)}/h",
                          ...
                          consumption(
                            ...
                            value:
                                "-${widget.settlement.woodConsumptionPerHour.toStringAsFixed(1)}/h",
                          ...
                          consumption(
                            ...
                            value:
                                "${(widget.settlement.foodSatisfaction * 100).toStringAsFixed(0)}%",
