            ...
            Align(
              ...
              child: UiPanel(
                ...
                child: Wrap(
                  ...
                  children: [
                    hudItem(
                      iconPath: "assets/icons/resources/wood_icon.png",
                      tooltip: "Drewno",
                      value: wood.toInt().toString(),
                      color: Colors.white,
                    ),
                    hudItem(
                      iconPath: "assets/icons/resources/plank_icon.png",
                      tooltip: "Deski",
                      value: plank.toInt().toString(),
                      color: Colors.orangeAccent,
                    ),
                    hudItem(
                      iconPath: "assets/icons/resources/berries_icon.png",
                      tooltip: "Jagody",
                      value: berries.toInt().toString(),
                      color: Colors.redAccent,
                    ),
                    hudItem(
                      iconPath: "assets/icons/resources/stone_icon.png",
                      tooltip: "Kamień",
                      value: stone.toInt().toString(),
                      color: Colors.grey.shade300,
                    ),
                    hudItem(
                      iconPath: "assets/icons/resources/bread_icon.png",
                      tooltip: "Chleb",
                      value: bread.toInt().toString(),
                      color: Colors.amber,
                    ),
                    hudItem(
                      iconPath: "assets/icons/resources/flour_icon.png",
                      tooltip: "Mąka",
                      value: flour.toInt().toString(),
                      color: Colors.white,
                    ),
                    hudItem(
                      iconPath: "assets/icons/resources/wheat_icon.png",
                      tooltip: "Pszenica",
                      value: wheat.toInt().toString(),
                      color: Colors.amberAccent,
                    ),
                    hudItem(
                      iconPath: "assets/icons/resources/stonetools_icon.png",
                      tooltip: "Narzędzia",
                      value: stoneTools.toInt().toString(),
                    ...
                    hudItem(
                      iconPath: "assets/icons/stats/gold_icon.png",
                      tooltip: "Monety",
                      value: money.toInt().toString(),
                      color: Colors.yellowAccent,
                    ),
                    hudItem(
                      iconPath: "assets/icons/stats/population_icon.png",
                      tooltip: "Ludność",
                      value: population.toString(),
                      color: Colors.lightBlueAccent,
                    ),
                    hudItem(
                      iconPath: "assets/icons/stats/morale_icon.png",
